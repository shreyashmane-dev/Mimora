...
import { emailLogIn, signInWithGoogle } from "@/lib/firebase";
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="mt-3 text-zinc-400 font-poppins text-sm font-light">
            Welcome back. Let's create something beautiful.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-xs font-poppins font-medium text-zinc-400 tracking-wider uppercase">
                  Password
                </label>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl text-sm font-poppins text-white bg-zinc-900/50 border border-zinc-800 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all duration-300"
                />
                <button
                  type="button"
