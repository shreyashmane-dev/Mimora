...
const TEMPLATES = [
  {
    ...
    theme: "Iridescent",
    desc: "Shimmering holographic gradients, modern and fluid.",
    mockBg: "bg-gradient-to-br from-pink-300 via-purple-300 to-indigo-400",
    mockCard: "bg-white/30 backdrop-blur-3xl border border-white/50 shadow-[0_8px_32px_rgba(255,255,255,0.2)]",
    mockText: "text-slate-900",
    mockAccent: "text-purple-700 font-bold tracking-tight",
    mockFont: "font-sans",
    mockBtn: "bg-white/70 text-purple-900 hover:bg-white backdrop-blur-md shadow-lg"
  },
  {
    id: "fire_and_ice",
    name: "Fire & Ice",
    theme: "Contrasting Elements",
    desc: "Fierce reds and cool blues, high impact design.",
    mockBg: "bg-gradient-to-tr from-red-900 via-black to-blue-900",
    mockCard: "bg-black/60 border border-blue-500/50 shadow-[0_0_25px_rgba(239,68,68,0.2)]",
    mockText: "text-blue-100",
    mockAccent: "bg-gradient-to-r from-red-500 to-blue-500 bg-clip-text text-transparent font-black",
    mockFont: "font-sans",
    mockBtn: "bg-gradient-to-r from-red-600 to-blue-600 text-white border-none"
  },
  {
    id: "gothic_romance",
    name: "Gothic Romance",
    theme: "Dark Elegance",
    desc: "Deep blacks, crimson highlights, ornate details.",
    mockBg: "bg-zinc-950",
    mockCard: "bg-zinc-900 border border-red-900/50 shadow-2xl",
    mockText: "text-zinc-300",
    mockAccent: "text-red-700 font-serif italic",
    mockFont: "font-serif",
    mockBtn: "bg-red-900 text-zinc-200 hover:bg-red-800 border border-red-700"
  },
  {
    id: "spring_meadow",
    name: "Spring Meadow",
    theme: "Fresh & Floral",
    desc: "Vibrant greens, soft yellows, cheerful atmosphere.",
    mockBg: "bg-lime-50",
    mockCard: "bg-white border-2 border-lime-200 shadow-sm",
    mockText: "text-lime-950",
    mockAccent: "text-lime-600 font-medium",
    mockFont: "font-sans",
    mockBtn: "bg-lime-500 text-white hover:bg-lime-600 shadow-md"
  },
  {
    id: "urban_graffiti",
    name: "Urban Graffiti",
    theme: "Street Style",
    desc: "Bold colors, chaotic splashes, edgy urban feel.",
    mockBg: "bg-stone-900",
    mockCard: "bg-stone-800 border-4 border-yellow-400 rotate-1",
    mockText: "text-white",
    mockAccent: "text-yellow-400 font-black uppercase transform -rotate-2 inline-block",
    mockFont: "font-sans",
    mockBtn: "bg-yellow-400 text-black font-black uppercase hover:bg-yellow-300 transform rotate-1"
  },
  {
    id: "autumn_leaves",
    name: "Autumn Leaves",
    theme: "Fall Colors",
    desc: "Crisp oranges, deep browns, cozy autumn mood.",
    mockBg: "bg-orange-100",
    mockCard: "bg-[#faf0e6] border border-orange-300 shadow-lg",
    mockText: "text-stone-800",
    mockAccent: "text-orange-700 font-serif",
    mockFont: "font-serif",
    mockBtn: "bg-orange-700 text-white hover:bg-orange-800"
  },
  {
    id: "neon_nights",
    name: "Neon Nights",
    theme: "Synthwave Dark",
    desc: "Dark city backdrop, glowing magenta lines.",
    mockBg: "bg-[#0a0a1a]",
    mockCard: "bg-[#111122]/90 border border-fuchsia-600 shadow-[0_0_20px_rgba(192,38,211,0.3)]",
    mockText: "text-fuchsia-50",
    mockAccent: "text-fuchsia-400 font-bold tracking-widest",
    mockFont: "font-sans",
    mockBtn: "bg-transparent border border-fuchsia-500 text-fuchsia-400 hover:bg-fuchsia-900/50"
  },
  {
    id: "candy_clouds",
    name: "Candy Clouds",
    theme: "Sweet & Fluffy",
    desc: "Cotton candy pinks and blues, joyful.",
    mockBg: "bg-gradient-to-b from-pink-200 to-sky-200",
    mockCard: "bg-white/80 border-none shadow-[0_10px_40px_rgba(236,72,153,0.2)] rounded-3xl",
    mockText: "text-slate-700",
    mockAccent: "text-pink-500 font-bold",
    mockFont: "font-sans",
    mockBtn: "bg-gradient-to-r from-pink-400 to-sky-400 text-white rounded-full"
  },
  {
    id: "metallic_silver",
    name: "Metallic Silver",
    theme: "Sleek Chrome",
    desc: "Polished silver, sharp contrast, premium industrial.",
    mockBg: "bg-zinc-900",
    mockCard: "bg-gradient-to-br from-zinc-300 via-zinc-400 to-zinc-500 border border-zinc-200 shadow-2xl",
    mockText: "text-zinc-900",
    mockAccent: "text-black font-black uppercase tracking-wider",
    mockFont: "font-sans",
    mockBtn: "bg-black text-zinc-300 hover:bg-zinc-800"
  },
  {
    id: "zen_garden",
    name: "Zen Garden",
    theme: "Peaceful Balance",
    desc: "Minimalist, balanced space, subtle textures.",
    mockBg: "bg-[#f4f1eb]",
    mockCard: "bg-[#fdfcf9] border-b-4 border-stone-300 shadow-sm",
    mockText: "text-stone-700",
    mockAccent: "text-stone-500 font-light tracking-[0.2em]",
    mockFont: "font-serif",
    mockBtn: "bg-stone-200 text-stone-700 hover:bg-stone-300 rounded-sm"
  },
  {
    id: "retro_arcade",
    name: "Retro Arcade",
    theme: "8-Bit Pixel",
    desc: "Pixelated elements, bright primary colors.",
    mockBg: "bg-[#000088]",
    mockCard: "bg-black border-4 border-[#00ff00] shadow-[4px_4px_0_#ff0000]",
    mockText: "text-[#00ff00]",
    mockAccent: "text-[#ffff00] font-black uppercase",
    mockFont: "font-mono",
    mockBtn: "bg-[#ff0000] text-white border-2 border-white rounded-none hover:bg-[#cc0000]"
  },
  {
    id: "enchanted_woods",
    name: "Enchanted Woods",
    theme: "Fairy Tale",
    desc: "Mystical lighting, deep purples and greens.",
    mockBg: "bg-indigo-950",
    mockCard: "bg-[#1e1b4b]/80 border border-purple-500/30 shadow-[0_0_30px_rgba(168,85,247,0.15)]",
    mockText: "text-purple-100",
    mockAccent: "text-emerald-400 font-serif italic",
    mockFont: "font-serif",
    mockBtn: "bg-purple-800 text-purple-100 hover:bg-purple-700 border border-purple-500/50"
  },
  {
    id: "sunflower_field",
    name: "Sunflower Field",
    theme: "Bright Yellow",
    desc: "Vivid yellows, cheerful, summery glow.",
    mockBg: "bg-yellow-100",
    mockCard: "bg-white border-2 border-yellow-400 shadow-[0_8px_0_#facc15]",
    mockText: "text-yellow-950",
    mockAccent: "text-yellow-600 font-black",
    mockFont: "font-sans",
    mockBtn: "bg-yellow-400 text-yellow-950 font-bold hover:bg-yellow-500 transform transition active:translate-y-1 active:shadow-none"
  },
  {
    id: "deep_space",
    name: "Deep Space",
    theme: "Galactic Void",
    desc: "Pitch black, subtle starlight, vastness.",
    mockBg: "bg-black",
    mockCard: "bg-black border border-slate-800 shadow-[0_0_50px_rgba(255,255,255,0.05)]",
    mockText: "text-slate-400",
    mockAccent: "text-white font-light tracking-widest uppercase",
    mockFont: "font-sans",
    mockBtn: "bg-slate-900 text-slate-300 border border-slate-700 hover:bg-slate-800"
  },
  {
    id: "cherry_bomb",
    name: "Cherry Bomb",
    theme: "Explosive Red",
    desc: "Bright red, high energy, bold statement.",
    mockBg: "bg-red-600",
    mockCard: "bg-red-500 border-4 border-white shadow-[10px_10px_0_rgba(0,0,0,0.2)]",
    mockText: "text-white",
    mockAccent: "text-red-100 font-black uppercase text-xl",
    mockFont: "font-sans",
    mockBtn: "bg-white text-red-600 font-black hover:bg-red-50"
  },
  {
    id: "neon_vibes",
    name: "Neon Vibes",
